...
ulang:
// function change(){
echo color("green","[] Kordinat :    -8.67".rand(000,9999).",115.21".rand(000,9999)."   []\n");
echo color("yellow","[] Android Id : ".date('His')."".rand(00,9999)."              []\n");
echo color("green","[] Packname : com.gojek.".date('i')."".rand()."   []\n");
...
echo color("yellow","[] Format Penulisan Nomor 62xxxxxxx  []\n");
	...
	gocar:
        ...
        sleep(3);
        $voc01 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"COBAGOFOOD0906"}');
        ...
        $expired13 = getStr1('"expiry_date":"','"',$cekvoucher,'13');
         ...
         echo color("white","▬▬▬▬▬▬▬▬▬▬▬▬▬▬ PIN MU = 123321 ▬▬▬▬▬▬▬▬▬▬▬▬")."\n";
         $data2 = '{"pin":"123321"}';
